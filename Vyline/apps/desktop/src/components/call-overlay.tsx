import { IconMic, IconMicOff, IconPhone, IconVideo } from "@/components/icons";
import { Avatar } from "@/components/vy-ui";
import { playCallEndSound, playRingtone, stopRingtone } from "@/lib/callSounds";
...
export function CallOverlay({
	...
	// 着信中（ringing）はループ再生、接続/終了で停止。通話終了時は効果音を一度再生
