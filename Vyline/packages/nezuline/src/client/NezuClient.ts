...
import { Client } from "@vyline/nezuline/stack";
import { BaseClient } from "@vyline/nezuline/stack/base";
...
export type NezuClient = Client;

export interface NezuLoginInit {
...
export function applyDesktopHeaders(
  client: Client,
  profile: DesktopProfile,
): void {
...
function createBase(init: NezuLoginInit): { base: BaseClient; mode: VylineDeviceMode } {
...
async function finalizeLogin(
  ...
  base.log("nezu:e2ee", { phase: "ensure-after-login", mode, ...e2ee });
