 ...
 * 2. `bun run nezu:find-native -- <name> --list-only` で Desktop に同名 Thrift / C++ があるか確認
...
export const RPC_DICTIONARY: readonly RpcEntry[] = [
  ...
  // ── Talk ───────────────────────────────────────────
  {
    ...
    desktopEvidence: [
      "TalkService_sendMessage_pargs",
      "line::SendMessageTask::sendMessage",
    ],
    path: "/S4",
  ...
  // ── Profile (self) ─────────────────────────────────
  {
    ...
    desktopEvidence: [
      "TalkService_getProfile_pargs",
      "TalkService_getProfile_presult",
    ],
    path: "/S4",
