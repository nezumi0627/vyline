...
export const MODULES_MAP: Record<FeatureId, FeatureModule> = {
  ...
  "login-email": {
    ...
    title: "メールログイン (E2EE)",
    description:
      "getRSAKeyInfo → loginV2 → /LF1 → confirmE2EELogin → loginV2 (token)",
    priority: "high",
    vylineFiles: [
      "Vyline/packages/nezuline/src/login/patchLogin.ts",
  ...
  "headers-transport": {
    ...
    title: "ヘッダー / トランスポート",
    description:
      "UA / X-Line-Application (TAB) / Host / Talk・Auth パスの Desktop 互換",
    priority: "high",
    vylineFiles: [
      "Vyline/packages/nezuline/src/login/patchTransport.ts",
  ...
  "e2ee-keys": {
    ...
    title: "E2EE 鍵管理",
    description:
      "Desktop keychain 取り込み・自己鍵検証・sender 鍵の整合",
    priority: "high",
    vylineFiles: [
  ...
  "e2ee-send": {
    ...
    title: "E2EE 送信",
    description:
      "encryptE2EEMessage / E2EE_UPDATE_SENDER_KEY 時の鍵ローテート",
    priority: "high",
    vylineFiles: [
      "Vyline/packages/nezuline/src/e2ee/letterSealing.ts",
      "Vyline/packages/nezuline/src/login/ensureE2EE.ts",
      "Vyline/packages/nezuline/src/client/NezuClient.ts",
  ...
  "e2ee-decrypt": {
    ...
    title: "E2EE 復号",
    description:
      "decryptE2EEMessage / グループ鍵 / BAD_DECRYPT・履歴復号",
    priority: "high",
    vylineFiles: [
      "Vyline/packages/nezuline/src/e2ee/letterSealing.ts",
      "Vyline/packages/nezuline/src/login/ensureE2EE.ts",
  ...
  "profile-self": {
    ...
    title: "自分プロフィール",
    description:
      "getProfile / updateProfileAttributes / OBS プロフィール画像・背景",
    priority: "medium",
    vylineFiles: [
      "Vyline/packages/nezuline/src/domain/profile.ts",
      "Vyline/packages/nezuline/src/protocol/profileOps.ts",
      "Vyline/packages/nezuline/src/dictionary/rpcMap.ts",
      "Vyline/backend/src/service/lineService.ts",
      "Vyline/backend/src/api/line.ts",
    ],
    desktop: {
    ...
    analysisDocs: [
      "docs/analysis/avatar-profile-api.md",
  ...
  "profile-contacts": {
    ...
    priority: "medium",
    vylineFiles: [
      "Vyline/packages/nezuline/src/domain/contacts.ts",
      "Vyline/packages/nezuline/stack/client/features/user/mod.ts",
      "Vyline/backend/src/service/lineService.ts",
      "Vyline/backend/src/api/line.ts",
    ],
    desktop: {
  ...
  "chat-admin": {
    ...
    priority: "medium",
    vylineFiles: [
      "Vyline/packages/nezuline/src/domain/chat.ts",
      "Vyline/packages/nezuline/stack/client/features/chat/mod.ts",
      "Vyline/packages/nezuline/stack/base/obs/mod.ts",
      "Vyline/backend/src/service/lineService.ts",
      "Vyline/backend/src/api/line.ts",
    ],
    desktop: {
