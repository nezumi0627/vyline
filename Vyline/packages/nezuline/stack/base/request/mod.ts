...
export class RequestClient {
	...
	constructor(client: BaseClient) {
		...
		if (
			deviceDetails.device === "DESKTOPWIN" ||
			deviceDetails.device === "DESKTOPMAC"
		) {
			this.userAgent =
				`DESKTOP:${deviceDetails.systemName}:${deviceDetails.systemVersion}(${deviceDetails.appVersion})`;
		} else {
	...
	public getHeader(
		...
		if (
			this.client.device === "DESKTOPWIN" ||
			this.client.device === "DESKTOPMAC"
		) {
