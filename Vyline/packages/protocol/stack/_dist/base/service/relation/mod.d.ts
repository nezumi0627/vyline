...
export declare class RelationService implements BaseService {
   ...
   */
  findContactBySearchIdOrTicketV3(options: { searchId: string }): Promise<LINETypes.Contact>;
  /**
   ...
   */
  findContactByPhoneV3(options: { phone: string }): Promise<LINETypes.Contact>;
  /**
   * @description Look up a user by phone number (E.164) and add them as a friend.
   */
  addFriendByPhone(options: { phone: string }): Promise<LINETypes.addFriendByMid_result["success"]>;
}
