 ...
 */
export declare function planetKdfSha512(
  salt: Uint8Array,
  ikm: Uint8Array,
  info: Uint8Array,
  outLen?: number,
...
export declare function planetKdfSha256(
  salt: Uint8Array,
  ikm: Uint8Array,
  info: Uint8Array,
  outLen?: number,
...
export declare function planetHkdfStage1(
...
export declare function derivePlanetMediaStreamKeying(
  baseKeying: Uint8Array,
  streamName?: "AUDIO" | "VIDEO" | "DATA",
): Uint8Array;
...
export declare function planetHkdfStage2(
...
/** AES-256-CTR encrypt. */
export declare function aesCtrEncrypt(
  key: Uint8Array,
  iv: Uint8Array,
  plaintext: Uint8Array,
): Uint8Array;
export declare function aesCtrDecrypt(
  key: Uint8Array,
  iv: Uint8Array,
